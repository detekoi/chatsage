...
TWITCH_BOT_USERNAME=${TWITCH_BOT_USERNAME:-WildcatSage}
...
GEMINI_MODEL_ID=${GEMINI_MODEL_ID:-gemini-3-flash-preview}
GEMINI_LITE_MODEL_ID=${GEMINI_LITE_MODEL_ID:-gemini-flash-lite-latest}
OPENAI_MODEL_ID=${OPENAI_MODEL_ID:-gpt-5.6-luna}
OPENAI_LITE_MODEL_ID=${OPENAI_LITE_MODEL_ID:-gpt-5.6-luna}
...
TWITCH_CLIENT_ID_SECRET=${TWITCH_CLIENT_ID_SECRET:-TWITCH_CLIENT_ID}
TWITCH_CLIENT_SECRET_SECRET=${TWITCH_CLIENT_SECRET_SECRET:-TWITCH_CLIENT_SECRET}
...
ENV_VARS=(
  ...
  "GEMINI_LITE_MODEL_ID=$GEMINI_LITE_MODEL_ID"
  "OPENAI_MODEL_ID=$OPENAI_MODEL_ID"
  "OPENAI_LITE_MODEL_ID=$OPENAI_LITE_MODEL_ID"
  ...
  "ALLOWED_CHANNELS_SECRET_NAME=$ALLOWED_CHANNELS_SECRET_NAME"
)
...
SECRETS_ARG="GEMINI_API_KEY=${GEMINI_API_KEY_SECRET}:latest,OPENAI_API_KEY=${OPENAI_API_KEY_SECRET}:latest,TWITCH_CLIENT_ID=${TWITCH_CLIENT_ID_SECRET}:latest,TWITCH_CLIENT_SECRET=${TWITCH_CLIENT_SECRET_SECRET}:latest,TWITCH_EVENTSUB_SECRET=${TWITCH_EVENTSUB_SECRET_SECRET}:latest"
